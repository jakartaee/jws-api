...
[![Build Status](https://travis-ci.com/eclipse-ee4j/jws-api.svg?branch=master)](https://travis-ci.com/eclipse-ee4j/jws-api)
...
* Most of the Jakarta Web Services Metadata project source code is licensed
under the [Eclipse Distribution License (EDL) v1.0.](https://www.eclipse.org/org/documents/edl-v10.php);
see the license information at the top of each source file.
* The source code for the Jakarta Web Services Metadata Specification project
